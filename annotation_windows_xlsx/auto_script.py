...
def loadEverything():
    ...
    # Load markups if available and if markup_log.xlsx exists
    if markup_files and os.path.exists(markup_log_file):
        df = pd.read_excel(markup_log_file, engine='openpyxl')
    ...
    for markupNode in final_markup_nodes:
        ...
        if existing_file:
            ...
            if class_name == "vtkMRMLMarkupsFiducialNode":
                ...
                markup_type = "markup"  # Default fallback for unknown markup types
